(function(punymce) {
	...
	punymce.Editor = Editor = function(e) {
		...
		this.settings = s = extend({
			content_css : '/assets/punymce/content.css',
			editor_css : '/assets/punymce/editor.css',
			blank_file : '/assets/punymce/blank.html',
			width : 0,
			height : 0,
			min_width : 260,
			min_height : 50,
        ...
        var pe = e.parentNode, w, h, ht, ul, n, r, f, sta = ['bold', 'italic', 'underline', 'left', 'center', 'right'];
