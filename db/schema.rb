...
ActiveRecord::Schema.define(version: 20180724145030) do
  ...
  create_table "agents", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    ...
    t.timestamp "lastlogin", default: -> { "CURRENT_TIMESTAMP" }, null: false
    ...
    t.binary "discogs_token"
  end

  create_table "airports", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "bars", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id"
  ...
  create_table "books", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    ...
    t.boolean "abandoned"
    t.date "abandoned_at"
    t.index ["agent_id"], name: "books_agent_idx"
    t.index ["agent_id"], name: "books_agents_idx"
  end

  create_table "brewing", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.date "date"
    t.string "product"
    t.string "task"
    t.string "company"
  ...
  create_table "categories", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id"
    t.integer "year"
  ...
  create_table "concerts", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id"
    t.date "date", null: false
    t.text "artists"
    ...
    t.boolean "delta"
    t.integer "geolocation_id"
    t.index ["agent_id"], name: "concerts_agent_idx"
    t.index ["agent_id"], name: "concerts_agents_idx"
  end

  create_table "currencies", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "eating", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id"
    t.date "date"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "events", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    ...
    t.boolean "delta"
    t.integer "geolocation_id"
    t.index ["agent_id"], name: "events_agent_idx"
  end

  create_table "exchanges", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "exercise", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id"
    t.date "date"
    t.text "activity"
  ...
  create_table "favoritemovies", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id"
  ...
  create_table "forums", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id"
    t.string "subject"
    t.text "body"
  ...
  create_table "gambling", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id"
    t.date "date", null: false
    t.string "name"
    t.string "location"
  ...
  create_table "geolocation_items", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "geolocation_id"
    t.integer "item_id"
    t.string "item_type"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["item_id", "item_type"], name: "index_geolocation_items_on_item_id_and_item_type"
  end

  create_table "geolocations", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "address"
  ...
  create_table "groceries", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.date "date"
    t.string "name"
    t.string "location"
    t.float "cost", limit: 24
  ...
  create_table "import_books", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "master_book_id"
    t.integer "agent_id"
    t.date "received"
    t.date "started"
  ...
  create_table "import_movies", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "master_movie_id"
    t.integer "agent_id"
    t.text "title"
    t.date "date"
  ...
  create_table "import_musics", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "import_restaurants", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id"
    t.date "date"
    t.text "name"
    t.text "location"
  ...
  create_table "importbacklogs", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "import_id"
    t.text "csvline", null: false, collation: "utf8_general_ci"
    t.boolean "imported", default: false, null: false
    t.integer "pbtentry_id"
    t.string "pbtentry_type"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["import_id"], name: "index_importbacklogs_on_import_id"
  end

  create_table "imports", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "agent_id"
    t.string "year"
    t.string "category"
    t.datetime "created_at", null: false
    ...
    t.index ["agent_id"], name: "index_imports_on_agent_id"
  end

  create_table "labels", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id"
  ...
  create_table "loans", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id", null: false
    t.date "date"
    t.date "ended"
  ...
  create_table "master_books", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.string "amazoncode"
    t.text "author"
    t.text "title"
    ...
    t.string "open_library"
  end

  create_table "master_movies", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "imdbcode"
    t.text "title"
    t.text "director"
    t.integer "year"
  ...
  create_table "master_musics", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "master_tvseries", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "title"
    t.integer "year"
  ...
  create_table "master_videogames", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.string "amazoncode"
    t.string "title"
    t.string "creator"
    t.string "platform"
  ...
  create_table "miles", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id"
    t.date "date", null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "movies", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "master_movie_id"
    t.integer "agent_id"
    t.date "started"
    t.date "date"
    ...
    t.string "userimage"
    t.integer "geolocation_id"
    t.index ["agent_id"], name: "movie_agent_idx"
    t.index ["geolocation_id"], name: "movie_geolocation_idx"
    t.index ["master_movie_id"], name: "movie_master_movie_idx"
  end

  create_table "musicplayed", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id"
    t.date "date"
    t.text "company"
    t.text "location"
  ...
  create_table "musics", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "master_music_id"
    t.integer "agent_id"
    t.date "date"
    t.datetime "created_at"
    ...
    t.boolean "delta"
    t.string "userimage"
    t.index ["agent_id"], name: "musics_agent_idx"
  end

  create_table "newsfeed", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id", null: false
  ...
  create_table "posts", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id", null: false
    t.text "post"
    t.timestamp "created", default: -> { "CURRENT_TIMESTAMP" }, null: false
  ...
  create_table "profiles", primary_key: ["id", "agent_id", "year"], force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["year", "agent_id"], name: "year", unique: true
  end

  create_table "profiles_themes", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "references", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "source_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["reference_type", "reference_id"], name: "index_references_on_reference_type_and_reference_id"
    t.index ["source_type", "source_id"], name: "index_references_on_source_type_and_source_id"
  end

  create_table "restaurants", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id"
    t.date "date", null: false
    t.string "name", limit: 128
    t.string "location", limit: 64
    ...
    t.boolean "delta"
    t.integer "geolocation_id"
    t.index ["agent_id"], name: "restaurants_agents_idx"
    t.index ["geolocation_id"], name: "restaurant_geolocation_idx"
  end
  ...
  create_table "takeaway", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id"
    t.date "date", null: false
    t.text "name"
    t.text "location"
  ...
  create_table "themes", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "tvseries", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id"
    ...
    t.index ["agent_id"], name: "index_tvseries_on_agent_id"
    t.index ["geolocation_id"], name: "index_tvseries_on_geolocation_id"
    t.index ["master_tvseries_id"], name: "index_tvseries_on_master_tvseries_id"
  end

  create_table "userimages", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "entry_id"
    t.string "entry_type"
    t.string "image_file_name"
    t.string "image_content_type"
  ...
  create_table "videogames", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "views", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id"
    t.integer "year", null: false
  ...
  create_table "weight", id: :integer, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.integer "agent_id"
    t.date "date"
    ...
    t.datetime "updated_at"
    t.integer "currency_id"
    t.index ["currency_id"], name: "index_weight_on_currency_id"
  end
