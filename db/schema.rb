...
ActiveRecord::Schema.define(version: 20141215123443) do
  ...
  create_table "brewing", force: true do |t|
    t.date     "date"
    t.string   "product"
    t.string   "task"
    t.string   "company"
  ...
  create_table "eating", force: true do |t|
    t.integer  "agent_id"
    t.date     "date"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "gambling", force: true do |t|
    t.integer  "agent_id"
    t.date     "date",                      null: false
    t.string   "name"
    t.string   "location"
  ...
  create_table "import_books", force: true do |t|
    t.integer   "master_book_id"
    t.integer   "agent_id"
    t.date      "received"
    t.date      "started"
  ...
  create_table "import_movies", force: true do |t|
    t.integer   "master_movie_id"
    t.integer   "agent_id"
    t.text      "title"
    t.date      "date"
  ...
  create_table "import_musics", force: true do |t|
  ...
  create_table "import_restaurants", force: true do |t|
    t.integer   "agent_id"
    t.date      "date"
    t.text      "name"
    t.text      "location"
  ...
  create_table "master_books", force: true do |t|
    t.string    "amazoncode"
    t.text      "author"
    t.text      "title"
  ...
  create_table "master_movies", force: true do |t|
    t.integer  "imdbcode"
    t.text     "title"
    t.text     "director"
    t.integer  "year"
  ...
  create_table "musicplayed", force: true do |t|
    t.integer  "agent_id"
    t.date     "date"
    t.text     "company"
    t.text     "location"
  ...
  create_table "newsfeed", force: true do |t|
    t.integer  "agent_id",              null: false
    t.integer  "foreign_id",            null: false
  ...
  create_table "profiles_themes", force: true do |t|
  ...
  create_table "takeaway", force: true do |t|
    t.integer  "agent_id"
    t.date     "date",                      null: false
    t.text     "name"
    t.text     "location"
  ...
  create_table "videogames", force: true do |t|
